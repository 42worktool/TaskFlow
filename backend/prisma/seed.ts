  ...
  await prisma.$transaction(
    async (tx) => {
      ...
      const cards = [
        {
          ...
          list_id: ids.lists.backlog,
          user_id: null,
          title: '사용자 인터뷰 결과 정리',
          description: '인터뷰 메모를 정리하고 launch scope에 반영합니다.',
          is_completed: false,
          start_at: null,
          deadline: null,
          sequence: 1024,
          actor: ids.users.member,
          created_at: dateFromNow(-24),
        },
        {
          id: ids.cards.analytics,
          list_id: ids.lists.backlog,
          user_id: null,
          title: 'Analytics event taxonomy',
          description: '핵심 행동 이벤트와 naming convention 초안 작성.',
          is_completed: false,
          start_at: dateFromNow(7),
        ...
        },
        {
          ...
          list_id: ids.lists.backlog,
          user_id: null,
          title: 'Google OAuth edge cases',
          description: '계정 연결과 callback 실패 시나리오를 점검합니다.',
          is_completed: false,
          start_at: null,
          deadline: dateFromNow(14),
          sequence: 3072,
          actor: ids.users.owner,
          created_at: dateFromNow(-18),
        },
        {
          id: ids.cards.onboarding,
          list_id: ids.lists.todo,
          user_id: null,
          title: '온보딩 체크리스트 개선',
          description: '첫 로그인부터 workspace 생성까지 안내 문구를 다듬습니다.',
          is_completed: false,
          start_at: dateFromNow(-5),
          deadline: dateFromNow(-2),
          sequence: 1024,
          actor: ids.users.member,
          created_at: dateFromNow(-16),
        },
        {
          id: ids.cards.search,
          list_id: ids.lists.todo,
          user_id: null,
          title: 'Cross-workspace search QA',
          description: '한국어/English 검색어와 권한별 결과를 확인합니다.',
          is_completed: false,
          start_at: dateFromNow(1),
          deadline: dateFromNow(3),
          sequence: 2048,
          actor: ids.users.admin,
          created_at: dateFromNow(-12),
        },
        {
          id: ids.cards.websocket,
          list_id: ids.lists.todo,
          user_id: null,
          title: 'WebSocket reconnect 테스트',
          description: '네트워크 단절 후 snapshot reconciliation을 확인합니다.',
          is_completed: false,
          start_at: dateFromNow(2),
          deadline: dateFromNow(5),
          sequence: 3072,
          actor: ids.users.owner,
          created_at: dateFromNow(-10),
        },
        {
          id: ids.cards.calendar,
          list_id: ids.lists.doing,
          user_id: null,
          title: 'Calendar weekly bar polish',
          description: '주 경계를 넘는 일정 바와 mobile layout을 검수합니다.',
          is_completed: false,
          start_at: dateFromNow(-1),
          deadline: dateFromNow(4),
          sequence: 1024,
          actor: ids.users.member,
          created_at: dateFromNow(-14),
        },
        {
          id: ids.cards.accessibility,
          list_id: ids.lists.doing,
          user_id: null,
          title: '접근성 keyboard audit',
          description: 'Modal focus trap, tab order, aria-label을 점검합니다.',
          is_completed: false,
          start_at: dateFromNow(-3),
          deadline: dateFromNow(0),
          sequence: 2048,
          actor: ids.users.admin,
          created_at: dateFromNow(-11),
        },
        {
          id: ids.cards.responsive,
          list_id: ids.lists.doing,
          user_id: null,
          title: 'Responsive board performance',
          description: '긴 제목과 많은 카드가 있는 모바일 보드 성능을 확인합니다.',
          is_completed: false,
          start_at: dateFromNow(0),
          deadline: dateFromNow(7),
          sequence: 3072,
          actor: ids.users.owner,
          created_at: dateFromNow(-8),
        },
        {
          id: ids.cards.invitation,
          list_id: ids.lists.review,
          user_id: null,
          title: '초대 이메일 copy review',
          description: '한영 혼합 초대 문구와 만료 안내를 최종 검수합니다.',
          is_completed: false,
          start_at: dateFromNow(-2),
          deadline: dateFromNow(1),
          sequence: 1024,
          actor: ids.users.admin,
          created_at: dateFromNow(-9),
        },
        {
          id: ids.cards.release,
          list_id: ids.lists.review,
          user_id: null,
          title: 'Release checklist v1.0',
          description: '배포 전 migration, health check, rollback 항목을 확인합니다.',
          is_completed: false,
          start_at: dateFromNow(0),
          deadline: dateFromNow(2),
          sequence: 2048,
        ...
        {
          id: ids.cards.database,
          list_id: ids.lists.review,
          user_id: null,
          title: 'Database backup drill',
          description: '복구 절차와 예상 소요 시간을 기록합니다.',
          is_completed: false,
          start_at: dateFromNow(3),
          deadline: dateFromNow(4),
          sequence: 3072,
        ...
        },
        {
          ...
          user_id: null,
          title: 'Design tokens 정리',
          description: 'Color, spacing, radius token을 공통 스타일로 정리했습니다.',
          is_completed: true,
          start_at: dateFromNow(-18),
          deadline: dateFromNow(-14),
          sequence: 1024,
          actor: ids.users.member,
          created_at: dateFromNow(-22),
        },
        {
          id: ids.cards.apiDocs,
          list_id: ids.lists.done,
          user_id: null,
          ...
          sequence: 2048,
          actor: ids.users.admin,
          created_at: dateFromNow(-15),
        },
        {
          id: ids.cards.kickoff,
          list_id: ids.lists.done,
          user_id: null,
          title: 'Product launch kickoff',
          description: '목표, 역할, milestone 합의를 완료했습니다.',
          is_completed: true,
          start_at: dateFromNow(-28),
          deadline: dateFromNow(-27),
          sequence: 3072,
          actor: ids.users.owner,
          created_at: dateFromNow(-29),
        },
        {
          id: ids.cards.goodFirstIssue,
          list_id: ids.lists.communityBacklog,
          user_id: null,
          title: 'Good first issue 후보 정리',
          description: '작고 독립적인 contributor task를 선별합니다.',
          is_completed: false,
          start_at: null,
          deadline: null,
          sequence: 1024,
          actor: ids.users.owner,
          created_at: dateFromNow(-13),
        },
        {
          id: ids.cards.contributionGuide,
          list_id: ids.lists.communityBacklog,
          user_id: null,
          title: 'Contribution guide 번역',
          description: 'English guide와 한국어 안내를 함께 제공합니다.',
          is_completed: false,
          start_at: dateFromNow(5),
          deadline: dateFromNow(10),
          sequence: 2048,
          actor: ids.users.member,
          created_at: dateFromNow(-10),
        },
        {
          id: ids.cards.darkMode,
          list_id: ids.lists.communityDoing,
          user_id: null,
          title: 'Dark mode color audit',
          description: 'Contrast ratio와 status color를 검토합니다.',
          is_completed: false,
          start_at: dateFromNow(-2),
        ...
        {
          id: ids.cards.translations,
          list_id: ids.lists.communityDoing,
          user_id: null,
          title: 'Community translations',
          description: '메뉴와 empty state 번역 누락을 찾습니다.',
          is_completed: false,
          start_at: dateFromNow(0),
          deadline: dateFromNow(8),
          sequence: 2048,
          actor: ids.users.owner,
          created_at: dateFromNow(-6),
        },
        {
          id: ids.cards.issueTemplate,
          list_id: ids.lists.communityDone,
          user_id: null,
          title: 'Bug report template',
          description: '재현 단계와 환경 정보를 받는 template을 배포했습니다.',
          is_completed: true,
          start_at: dateFromNow(-16),
          deadline: dateFromNow(-15),
          sequence: 1024,
          actor: ids.users.admin,
          created_at: dateFromNow(-17),
        },
        {
          id: ids.cards.readme,
          list_id: ids.lists.communityDone,
          ...
          description: '로컬 실행과 contribution flow를 문서화했습니다.',
          is_completed: true,
          start_at: dateFromNow(-11),
          deadline: dateFromNow(-8),
          sequence: 2048,
          actor: ids.users.owner,
          created_at: dateFromNow(-12),
        ...
        {
          id: ids.cards.ownerInbox,
          list_id: null,
          user_id: ids.users.owner,
          title: '개인 메모: demo flow 연습',
          description: 'Board → Calendar → Dashboard → Messenger 순서로 시연합니다.',
          is_completed: false,
          start_at: null,
          deadline: dateFromNow(1),
          sequence: 1024,
        ...
        {
          id: ids.cards.ownerReminder,
          list_id: null,
          user_id: ids.users.owner,
          title: 'Follow up with beta users',
          description: '다음 주 feedback session 일정을 잡습니다.',
          is_completed: false,
          start_at: dateFromNow(4),
          deadline: dateFromNow(4),
          sequence: 2048,
          actor: ids.users.owner,
        ...
        {
          id: ids.cards.memberInbox,
          list_id: null,
          user_id: ids.users.member,
          title: '민아 개인 Inbox',
          description: '공유 전 초안을 개인 Inbox에서 정리합니다.',
          is_completed: false,
          start_at: null,
          deadline: null,
          sequence: 1024,
      ...
      const cardLabels = [
        ...
        [ids.cards.search, ids.labels.feature],
        [ids.cards.search, ids.labels.backend],
        [ids.cards.websocket, ids.labels.bug],
        [ids.cards.websocket, ids.labels.backend],
        [ids.cards.calendar, ids.labels.feature],
        [ids.cards.calendar, ids.labels.frontend],
        [ids.cards.accessibility, ids.labels.urgent],
        [ids.cards.accessibility, ids.labels.frontend],
        [ids.cards.responsive, ids.labels.frontend],
        [ids.cards.invitation, ids.labels.design],
        [ids.cards.release, ids.labels.urgent],
        [ids.cards.release, ids.labels.backend],
        [ids.cards.database, ids.labels.backend],
        [ids.cards.design, ids.labels.design],
        [ids.cards.goodFirstIssue, ids.labels.community],
        [ids.cards.goodFirstIssue, ids.labels.helpWanted],
        [ids.cards.contributionGuide, ids.labels.docs],
        [ids.cards.darkMode, ids.labels.helpWanted],
        [ids.cards.translations, ids.labels.community],
        [ids.cards.issueTemplate, ids.labels.docs],
      ...
      const attachments = [
        [
          ...
          ids.cards.calendar,
          'https://example.com/taskflow/calendar-wireframe.pdf',
          'calendar-wireframe.pdf',
          ids.users.member,
        ],
        [
          '88888888-8888-4888-8888-000000000002',
          ids.cards.release,
          'https://example.com/taskflow/release-checklist.md',
        ...
        [
          ...
          ids.cards.darkMode,
          'https://example.com/taskflow/color-audit.png',
          'color-audit.png',
          ids.users.admin,
        ],
      ] as const
      ...
      const comments = [
        [
          ...
          ids.cards.onboarding,
          ids.users.admin,
          '첫 화면 CTA가 조금 더 명확하면 좋겠어요.',
          -4,
        ],
        [
        ...
        [
          ...
          ids.cards.calendar,
          ids.users.member,
          'Desktop/mobile 모두 확인했고 screenshot 첨부했습니다.',
          -1,
        ],
        [
          'aaaaaaaa-aaaa-4aaa-8aaa-000000000005',
          ids.cards.accessibility,
          ids.users.viewer,
          'Keyboard only navigation에서 modal close가 어렵습니다.',
          -1,
        ],
        [
        ...
        [
          ...
          ids.cards.database,
          ids.users.owner,
          '복구 목표 시간은 15분으로 기록해주세요.',
          0,
        ],
        [
          'aaaaaaaa-aaaa-4aaa-8aaa-000000000008',
          ids.cards.goodFirstIssue,
          ids.users.owner,
          '초보 contributor가 재현 가능한 항목 위주로 골라주세요.',
          -5,
        ],
        [
          ...
          ids.cards.darkMode,
          ids.users.admin,
          'Status colors need one more contrast pass.',
          -2,
        ],
        [
      ...
      const workspaceMessages = [
        [
          ...
          ids.workspaces.product,
          ids.users.owner,
          null,
          '오늘 stand-up 시작합니다. Blocker 있으면 공유해주세요.',
          -3,
          1,
        ],
        [
        ...
        [
          ...
          ids.users.admin,
          null,
          'OAuth QA checklist를 Review에 올려주세요.',
          -2,
          4,
        ],
        [
          ...
          ids.users.viewer,
          ids.cards.accessibility,
          'Keyboard audit에서 blocker 하나 발견했습니다.',
          -1,
          5,
        ],
        [
          ...
          ids.users.owner,
          ids.cards.release,
          'Release checklist 기준으로 final check 진행할게요.',
          -1,
          7,
        ],
        [
        ...
        [
          ...
          ids.users.member,
          null,
          'Demo data와 screenshots 업데이트했습니다.',
          0,
          2,
        ],
        [
          ...
          ids.users.owner,
          null,
          'Great work team. 오후에 demo rehearsal 합시다!',
          0,
          3,
        ],
        [
          'bbbbbbbb-bbbb-4bbb-8bbb-000000000009',
          ids.workspaces.openSource,
          ids.users.admin,
          null,
          'Welcome contributors! 이번 주 roadmap 공유합니다.',
          -3,
          6,
        ],
        [
      ...
      const activityLogs = [
        activity({
          ...
          workspace_id: ids.workspaces.product,
          actor_user_id: ids.users.owner,
          operation: 'INSERT',
          event_type: 'MEMBER_ADDED',
          target_type: 'MEMBER',
          target_id: ids.users.admin,
          transaction_id: 1001n,
          created_at: dateFromNow(-28),
        }),
        activity({
          ...
          target_type: 'LIST',
          target_id: ids.lists.backlog,
          transaction_id: 1002n,
          created_at: dateFromNow(-25),
        }),
        activity({
          id: 'dddddddd-dddd-4ddd-8ddd-000000000003',
          workspace_id: ids.workspaces.product,
          actor_user_id: ids.users.member,
          operation: 'INSERT',
          event_type: 'CARD_CREATED',
          target_type: 'CARD',
          target_id: ids.cards.design,
          transaction_id: 1003n,
          created_at: dateFromNow(-22),
        }),
        activity({
          id: 'dddddddd-dddd-4ddd-8ddd-000000000004',
          workspace_id: ids.workspaces.product,
          actor_user_id: ids.users.admin,
          operation: 'INSERT',
          event_type: 'COMMENT_CREATED',
          target_type: 'COMMENT',
          target_id: 'aaaaaaaa-aaaa-4aaa-8aaa-000000000001',
          transaction_id: 1004n,
          created_at: dateFromNow(-18),
        }),
        activity({
        ...
        activity({
          ...
          target_type: 'CARD',
          target_id: ids.cards.design,
          transaction_id: 1006n,
          created_at: dateFromNow(-14),
        }),
        activity({
          id: 'dddddddd-dddd-4ddd-8ddd-000000000007',
          workspace_id: ids.workspaces.product,
          actor_user_id: ids.users.admin,
          operation: 'INSERT',
          event_type: 'CARD_CREATED',
          target_type: 'CARD',
          target_id: ids.cards.apiDocs,
          transaction_id: 1007n,
          created_at: dateFromNow(-12),
        }),
        activity({
          id: 'dddddddd-dddd-4ddd-8ddd-000000000008',
          workspace_id: ids.workspaces.product,
          actor_user_id: ids.users.admin,
          operation: 'UPDATE',
          event_type: 'CARD_COMPLETED',
        ...
        activity({
          ...
          target_type: 'MEMBER',
          target_id: ids.users.viewer,
          transaction_id: 1009n,
          created_at: dateFromNow(-7),
        }),
        activity({
          ...
          event_type: 'CARD_CREATED',
          target_type: 'CARD',
          target_id: ids.cards.calendar,
          transaction_id: 1010n,
          created_at: dateFromNow(-5),
        }),
        activity({
          id: 'dddddddd-dddd-4ddd-8ddd-000000000011',
          workspace_id: ids.workspaces.product,
          actor_user_id: ids.users.member,
          operation: 'INSERT',
          event_type: 'COMMENT_CREATED',
          target_type: 'COMMENT',
          target_id: 'aaaaaaaa-aaaa-4aaa-8aaa-000000000004',
          transaction_id: 1011n,
          created_at: dateFromNow(-3),
        }),
        activity({
          id: 'dddddddd-dddd-4ddd-8ddd-000000000012',
          workspace_id: ids.workspaces.product,
          actor_user_id: ids.users.admin,
          operation: 'UPDATE',
          event_type: 'CARD_UPDATED',
          target_type: 'CARD',
          target_id: ids.cards.accessibility,
          transaction_id: 1012n,
          created_at: dateFromNow(-2),
        }),
        activity({
          id: 'dddddddd-dddd-4ddd-8ddd-000000000013',
          workspace_id: ids.workspaces.product,
          actor_user_id: ids.users.owner,
          operation: 'UPDATE',
          event_type: 'CARD_MOVED',
          target_type: 'CARD',
          target_id: ids.cards.release,
          transaction_id: 1013n,
          created_at: dateFromNow(-1),
        }),
        activity({
          id: 'dddddddd-dddd-4ddd-8ddd-000000000014',
          workspace_id: ids.workspaces.product,
          actor_user_id: ids.users.admin,
          operation: 'INSERT',
          event_type: 'COMMENT_CREATED',
          target_type: 'COMMENT',
          target_id: 'aaaaaaaa-aaaa-4aaa-8aaa-000000000006',
          transaction_id: 1014n,
          created_at: dateFromNow(0),
        }),
        activity({
          id: 'eeeeeeee-eeee-4eee-8eee-000000000001',
          workspace_id: ids.workspaces.openSource,
          actor_user_id: ids.users.admin,
          operation: 'INSERT',
          event_type: 'MEMBER_ADDED',
          target_type: 'MEMBER',
          target_id: ids.users.owner,
          transaction_id: 2001n,
          created_at: dateFromNow(-20),
        }),
        activity({
          ...
          event_type: 'CARD_CREATED',
          target_type: 'CARD',
          target_id: ids.cards.goodFirstIssue,
          transaction_id: 2002n,
          created_at: dateFromNow(-13),
        }),
        activity({
          ...
          event_type: 'CARD_CREATED',
          target_type: 'CARD',
          target_id: ids.cards.issueTemplate,
          transaction_id: 2003n,
          created_at: dateFromNow(-10),
        }),
        activity({
        ...
        activity({
          ...
          event_type: 'COMMENT_CREATED',
          target_type: 'COMMENT',
          target_id: 'aaaaaaaa-aaaa-4aaa-8aaa-000000000010',
          transaction_id: 2005n,
          created_at: dateFromNow(-7),
        }),
        activity({
          ...
          event_type: 'CARD_UPDATED',
          target_type: 'CARD',
          target_id: ids.cards.translations,
          transaction_id: 2006n,
          created_at: dateFromNow(-1),
        }),
      ]
