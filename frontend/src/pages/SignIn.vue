    ...
    <div class="oauth-section">
      ...
      >
        <svg class="google-icon" viewBox="0 0 18 18" aria-hidden="true">
          ...
          <path fill="#FBBC05" d="M3.96 10.71A5.42 5.42 0 0 1 3.68 9c0-.59.1-1.16.28-1.71V4.96H.96A9 9 0 0 0 0 9c0 1.45.35 2.82.96 4.04l3-2.33Z" />
          <path fill="#EA4335" d="M9 3.58c1.32 0 2.51.46 3.45 1.35l2.58-2.59A8.65 8.65 0 0 0 9 0 9 9 0 0 0 .96 4.96l3 2.33C4.67 5.16 6.66 3.58 9 3.58Z" />
        </svg>
        Google로 계속하기
      </button>
    </div>
