...
This Toy scope does not include friend requests, acceptance, blocking, or
presence. Those can be added as separate features without changing the
canonical friendship pair. The Account page is the temporary management UI;
it can move to a dedicated social page when presence and DM are introduced.
